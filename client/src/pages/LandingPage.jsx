        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              Get real-time air quality data, health suggestions, and detailed pollutant analysis 
              for any city around the world. Make informed decisions for better health.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
              BreatheEasy is an open-source project that helps you monitor air quality in your area, 
              understand pollutant levels, and take informed actions for better health. With real-time 
              data from cities worldwide, interactive maps, and personalized health guidance, 
              we make understanding air quality simple, informative, and accessible.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Get live updates on air quality index and pollutant concentrations for any location worldwide.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Receive personalized health suggestions and precautions based on current air quality levels.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Access 7-day air quality forecasts to plan outdoor activities and protect your health.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-emerald-500 to-green-600 rounded-2xl p-8 text-white">
                <h3 className="text-2xl font-bold mb-4">Why Air Quality Matters</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Everything you need to monitor and understand air quality in your area and around the world.
            </p>
          </div>
            ...
            <div className="inline-block">
              ...
              >
                <div className="bg-gradient-to-r from-emerald-500 to-green-600 rounded-2xl p-8 text-white card-hover">
                  ...
                  <p className="text-emerald-100 mb-4">Project Maintainer</p>
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-600 to-green-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-emerald-100 mb-8">
            Join thousands of users who are already making informed decisions about their health and environment.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <img src="/favicon.png" alt="Logo" className="w-8 h-8" />
                <h3 className="text-2xl font-bold text-green-400">BreatheEasy</h3>
              </div>
              <p className="text-gray-300 mb-4 max-w-md">
                An open-source air quality monitoring platform that helps you understand 
                and track air quality data for better health decisions.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li>
                  <a href="https://github.com/prasoonk1204/BreatheEasy" className="hover:text-green-400 transition-colors flex items-center gap-2">
                    GitHub Repository
                    <ExternalLink className="w-4 h-4" />
                  </a>
                </li>
                <li>
                  <a href="https://github.com/prasoonk1204/BreatheEasy/blob/main/README.md" className="hover:text-green-400 transition-colors flex items-center gap-2">
                    Documentation
                    <ExternalLink className="w-4 h-4" />
                  </a>
                </li>
                <li>
                  <a href="https://github.com/prasoonk1204/BreatheEasy/issues" className="hover:text-green-400 transition-colors flex items-center gap-2">
                    Report Issues
                    <ExternalLink className="w-4 h-4" />
                  </a>
                </li>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>
              ...
              <a href="https://github.com/prasoonk1204/BreatheEasy/blob/main/License.md" className="text-green-400 hover:underline">
                MIT License
              </a>
